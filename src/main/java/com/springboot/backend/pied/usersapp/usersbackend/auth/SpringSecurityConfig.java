package com.springboot.backend.pied.usersapp.usersbackend.auth;

import com.springboot.backend.pied.usersapp.usersbackend.auth.filter.JwtAuthenticationFilter;
import com.springboot.backend.pied.usersapp.usersbackend.auth.filter.JwtValidationFilter;
...
public class SpringSecurityConfig {
    ...
    // Se registra en el contenedor de spring como un componente -> Bean
    @Bean
    SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception{
        return httpSecurity.authorizeHttpRequests(authz ->
            authz.requestMatchers(HttpMethod.GET, "/api/users", "/api/users/page/{page}").permitAll()
                    ...
                    .csrf(config -> config.disable()) // Evitar ataques de CrossSide, para formularios
